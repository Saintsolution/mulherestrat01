...
// O seu ID do vídeo de vendas (VSL)
const VSL_VIDEO_ID = "s2ejuzw47q";
      ...
      <div className="container grid grid-cols-1 items-center gap-14 py-16 md:py-24 lg:grid-cols-12 lg:gap-12 lg:py-32">
        ...
        <div className="lg:col-span-5 reveal">
          ...
          <div className="mt-10 flex flex-col items-start gap-5 sm:flex-row sm:items-center">
            <a
              href="#comprar"
              className="group inline-flex items-center gap-5 bg-ink px-7 py-4 text-[10px] font-semibold uppercase tracking-[0.22em] text-paper shadow-editorial transition-all duration-500 hover:bg-gold hover:text-ink sm:px-9 sm:py-5 sm:text-[11px] rounded-none"
            >
        ...
        <div className="lg:col-span-7 reveal">
          <div className="relative">
            ...
            {/* Passei o VSL_VIDEO_ID aqui e adicionei o aspect 16:9 que é o padrão de vídeo horizontal */}
            <WistiaPlayer mediaId={VSL_VIDEO_ID} aspect="4:3" />
            
            <div className="mt-5 flex items-center justify-between">
              <span className="label-meta text-gold">Vídeo de Vendas</span>
              <span className="label-meta opacity-50 text-ink">Não deixe de ver</span>
            </div>
          </div>
        </div>
      </div>
